...
#define MODULE_NAME "CueingTest"
#define LOCTEXT_NAMESPACE "FCueingTestModule"

void FCueingTestModule::StartupModule()
{
...
void FCueingTestModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FCueingTestModule, CueingTest)
