...
#define MODULE_NAME "Cueing"
#define LOCTEXT_NAMESPACE "FCueingModule"

void FCueingModule::StartupModule()
{
...
void FCueingModule::ShutdownModule()
{
...
IMPLEMENT_MODULE(FCueingModule, Cueing)
